  ...
  return (
    <nav>
      ...
      <div id="navRight" className="navRight">
        <ul>
          <li><a href="/launchpadpurdue.github.io/about"><button component={Link} className="signin">About</button></a></li>
          <li><a href="/launchpadpurdue.github.io/faq"><button component={Link} className="signin">FAQ</button></a></li>
          <li><a href="/launchpadpurdue.github.io/sponsors"><button component={Link} className="signin">Sponsors</button></a></li>
          <li><a href="/launchpadpurdue.github.io/team"><button component={Link} className="signin">Team</button></a></li>
          <li><a href="/launchpadpurdue.github.io/contact"><button component={Link} className="signin">Contact</button></a></li>
        </ul>
      </div>
    </nav>
  )
